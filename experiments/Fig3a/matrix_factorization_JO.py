...
for i in range(NITER):
    ...
    if (len(report)==0 or aux_time.AccumulatingTimer.get_elapsed("LCVI")-report[-1][0]>=200): #report results
        ...
        if aux_time.AccumulatingTimer.get_elapsed("LCVI")>24000: break
